...
<body>
  ...
  <h3 style="text-align: center; margin-top: 10px; margin-bottom: 20px;">Products Register</h3>

  <?php
  $connection=openCon();
  $query = mysqli_query($connection,"SELECT Product_Id,Name,Version,Type,Price FROM product");
  ?>
